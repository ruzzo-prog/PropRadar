...
if [ "$missing" -ne 0 ]; then
	printf '%s\n' "reverse-proxy preflight: задайте пути на хосте: N8N_TLS_FULLCHAIN, N8N_TLS_PRIVKEY, EVOLUTION_TLS_FULLCHAIN, EVOLUTION_TLS_PRIVKEY (см. docker/reverse-proxy/README.md)." >&2
	exit 1
fi

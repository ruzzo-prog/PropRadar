...
Разделы ниже пронумерованы **§1–§8** в тексте документа: роли компонентов, каталоги Let's Encrypt и symlink, два сценария certbot, шесть переменных PEM, nginx/preflight, чеклист нового FQDN, ограничения compose, верификация.
